    ...
    _createClass(AutoCompleteValidator, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                rest = _objectWithoutProperties(_props, ['errorMessages', 'validators', 'requiredError', 'helperText', 'validatorListener', 'autosuggestProps']);

            var isValid = this.state.isValid;

            return _react2.default.createElement(_reactAutosuggest2.default, _extends({
                renderInputComponent: _react2.default.createElement(_TextField2.default, _extends({}, rest, {
                    error: !isValid,
